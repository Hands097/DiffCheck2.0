                                            ...
                                            <div style="display: flex; gap: 8px;">
                                                <form method="POST" id="archive-user-form-<?php echo $u['id']; ?>">
                                                  ...
                                                  <form method="POST" id="wipe-user-form-<?php echo $u['id']; ?>">
                                                    ...
                                                    <button type="button" class="btn-action btn-delete" onclick="document.getElementById('wipe-user-modal-<?php echo $u['id']; ?>').classList.add('active')"><i class="fa-solid fa-skull"></i> Wipe Data</button>
                                                </form>
                                            </div>
                                        <?php else: ?>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <form method="POST" id="force-archive-form-<?php echo $at['id']; ?>">
                                            ...
                                            <input type="hidden" name="admin_archive_tournament" value="1">
                                ...
                                <tr style="opacity: 0.6;">
                                    ...
                                    <td>
                                        <form method="POST" style="display:inline;" id="restore-tourn-form-<?php echo $arc['id']; ?>">
                                            ...
                                            <input type="hidden" name="admin_restore_tournament" value="1">
